...
const teamMembers = [
  {
    ...
    description: 'Vårt erfarna köksteam skapar varje dag handgjorda pizzor och smakrika rätter med de bästa råvarorna. Snabb service utan att kompromissa på kvaliteten.',
  },
  {
    name: 'Servicepersonalen',
    role: 'Serveringspersonal',
    description: 'Välutbildad och vänlig personal som välkomnar alla gäster med ett leende. Vi ser till att din upplevelse på Valentino alltid är trevlig och minnesvärd.',
  },
  {
    name: 'Leverans & Avhämtning',
    role: 'Avhämtning & Take Away',
    description: 'Beställ per telefon och hämta din mat när det passar dig. Vi förbereder din beställning snabbt och noggrant så att maten är varm och god när du hämtar den.',
  },
]
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
            ...
            >
              ...
              <p className="font-inter text-base text-[#1C1C1C]/70 leading-relaxed mb-6">
                {content.about_text || 'Valentino grundades av familjen Rossi med en dröm om att ge Stockholmarna en genuin smak av Italien.'}
              </p>
              <p className="font-inter text-base text-[#1C1C1C]/70 leading-relaxed">
                {content.about_story || 'Restaurangens inredning speglar det autentiska italienska levnadssättet.'}
              </p>
            </motion.div>
